        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumbs bg-light mb-4">
                    ...
                    <li class="breadcrumbs__item">
                        <a href="javascipt:;" class="breadcrumbs__url">{{ __('frontend.News') }}</a>
                    </li>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="article__entry">
                                ...
                                <div class="article__content">
                                    ...
                                    <h5>
                                        <a href="{{ route('news-details', $post->slug) }}">
                                            {!! truncateSafe($post->title, 45) !!}
                                        </a>
                                    </h5>
                                    <p>
                                        {!! truncateSafe($post->content, 100) !!}
                                        {{-- {!! mb_strlen(strip_tags($post->content)) > 100
