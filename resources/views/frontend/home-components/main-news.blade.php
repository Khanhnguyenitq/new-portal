                                        ...
                                        <li class="list-inline-item">
                                            <h5>
                                                <a href="{{ route('news-details', $popularNews->slug) }}">
                                                    {!! truncateSafe($popularNews->title, 45) !!}
                        ...
                        <div class="item">
                            ...
                            <div class="article__entry">
                                ...
                                <div class="article__content">
                                    ...
                                    <h5>
                                        <a href="{{ route('news-details', $sectionOneNews->slug) }}">
                                            {!! truncateSafe($sectionOneNews->title, 40) !!}
                                        </a>
                                    </h5>
                        ...
                        <div class="item">
                            ...
                            <div class="article__entry">
                                ...
                                <div class="article__content">
                                    ...
                                    <h5>
                                        <a href="{{ route('news-details', $sectionTwoNews->slug) }}">
                                            {!! truncateSafe($sectionTwoNews->title, 40) !!}
                                        </a>
                                    </h5>
                                                ...
                                                <div class="article__content">
                                                    ...
                                                    <h5>
                                                        <a
                                                            ...
                                                            {!! truncateSafe($sectionThreeNews->title, 45) !!}
                                                        </a>
                                                    </h5>
                                                    ...
                                                    <div class="card__post__title">
                                                        <h5>
                                                            <a
                                                                ...
                                                                {!! truncateSafe($sectionFourNews->title,45) !!}
                                                            </a>
                                                        </h5>
                                                        <p class="d-none d-lg-block d-xl-block mb-0">
                                                            {!! truncateSafe($sectionFourNews->content, 100) !!}
                                                            {{-- {!! mb_strlen(strip_tags($sectionFourNews->content)) > 100
                                                                ? mb_substr(strip_tags($sectionFourNews->content), 0, 100) . '...'
                                                                : $sectionFourNews->content !!} --}}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    @if ($loop->index === 0)
                                        <div class="article__entry">
                                            ...
                                            <div class="article__content">
                                                ...
                                                <h5>
                                                    <a href="{{ route('news-details', $mostViewedNews->slug) }}">
                                                        {{ truncateSafe($mostViewedNews->title, 45) }}
                                                    </a>
                                                </h5>
                                                <p>
                                                    {!! truncateSafe($mostViewedNews->content, 100) !!}
                                                </p>
                                                <a href="{{ route('news-details', $mostViewedNews->slug) }}"
